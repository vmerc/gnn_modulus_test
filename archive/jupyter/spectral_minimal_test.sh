...
CONFIG_NAME="Config1Group3Shortx1MultiTest"
SAVING_NAME="gd"
MESH_LIST="/work/m24046/m24046mrcr/results_data_30min/maillage_3.slf"
LOAD_FLAG="--load" 

srun apptainer exec --bind /tmpdir,/work --nv /work/conteneurs/sessions-interactives/modulus-24.01-calmip-si.sif python spectral_minimal_test.py --config_name "$CONFIG_NAME" --saving_name "$SAVING_NAME" --mesh_list "$MESH_LIST" $LOAD_FLAG
