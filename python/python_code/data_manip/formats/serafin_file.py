...
class SerafinFile():
    ...
    def __read_bnd(self):
        ...
        self.__lihbor = np.zeros((self.__nptfr), dtype=np.int64)
        self.__liubor = np.zeros((self.__nptfr), dtype=np.int64)
        self.__livbor = np.zeros((self.__nptfr), dtype=np.int64)
        ...
        self.__litbor = np.zeros((self.__nptfr), dtype=np.int64)
        ...
        self.__nbor = np.zeros((self.__nptfr), dtype=np.int64)
        self.__color = np.zeros((self.__nptfr), dtype=np.int64)
